...
<html lang="en">
  <head>
    ...
    <title>Hapus Perlengkapan</title>
  </head>
  <body>
    <!-- Awal Navbar -->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ms-auto">
            ...
            <a href="perlengkapan.php" class="nav-link"
              >Perlengkapan</a
            >
    ...
    <section class="form">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="text-center mt-3">Hapus Perlengkapan</h2>
            <hr />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <form action="perlengkapan-proses.php" method="post">
              <input type="hidden" name="id" value="<?= $_GET['id_perlengkapan']; ?>" />
              <center>
                <table>
                  <tr>
                    <td>
